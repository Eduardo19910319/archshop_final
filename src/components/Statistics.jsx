    ...
    <section className="w-full py-20 md:py-28 bg-white relative">
      <div className="container mx-auto px-4 sm:px-6 max-w-7xl relative z-10 text-center flex flex-col items-center">
        <Reveal direction="up" delay={0.1}>
          <p className="text-archshop-orange font-medium text-sm md:text-base mb-4 tracking-widest uppercase font-outfit">Arquitetura do Brasil para o Mundo</p>
        </Reveal>
        <Reveal direction="up" delay={0.2}>
          <h2 className="text-4xl md:text-5xl lg:text-7xl font-outfit font-medium text-zinc-900 mb-8 tracking-tight leading-[1.1] uppercase">
            Nossa autoridade nos leva<br />
            <span className="text-zinc-400 italic font-light">mais longe.</span>
          </h2>
        </Reveal>
        <Reveal direction="up" delay={0.3}>
          <p className="text-zinc-500 text-lg md:text-xl max-w-lg mx-auto mb-16 font-light">
        ...
        <Reveal direction="up" delay={0.4}>
          <div className="w-full max-w-2xl mx-auto bg-white rounded-[2.5rem] p-8 md:p-12 shadow-[0_20px_60px_-15px_rgba(0,0,0,0.05)] border border-zinc-100 flex flex-col items-center mb-12 relative overflow-hidden group">
            ...
            <p className="text-zinc-800 text-xl font-medium text-center relative z-10 font-outfit">
              <span className="text-archshop-orange font-bold text-4xl block mb-1">Mais de 100</span> MUNICÍPIOS ATENDIDOS
            </p>
          </div>
        </Reveal>
        <Reveal direction="up" delay={0.5}>
          <a href="#galeria" className="inline-flex items-center justify-center gap-3 px-12 py-5 bg-zinc-900 hover:bg-black text-white rounded-full font-medium transition-all shadow-xl shadow-zinc-900/20 text-lg group">
            Explorar Projetos <ArrowRight className="w-5 h-5 group-hover:translate-x-1 transition-transform" />
          </a>
        </Reveal>
      </div>
    </section>
